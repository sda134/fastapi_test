...
namespace Mtec.Internal.Mitsubishi.MXDebugger
{
    ...
    public class Config
    {
        ...
        public static bool LoadFromXmlFile()
        {
            ...
            return task.Result;
#else
            return XMLSerializeOperator <ConfigFormat>.DeserializeFromXmlFile(Config.FileNameFullPath, out _instance);
#endif
        }
        ...
        public static bool SaveToXmlFile()
        {
            ...
            return task.Result;
#else
            return XMLSerializeOperator<ConfigFormat>.SerializeToXmlFile(Config.FileNameFullPath, _instance);
#endif
        }
