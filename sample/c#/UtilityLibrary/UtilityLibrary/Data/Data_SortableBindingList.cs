...
namespace Mtec.UtilityLibrary.Data
{
    ...
    public class SortableBindingList<T> : System.ComponentModel.BindingList<T>
        where T : class
    {
        // https://garafu.blogspot.jp/2016/09/cs-sorablebindinglist.html
        ...
        /// ソートを行う抽象化プロパティ
        /// </summary>
        private System.ComponentModel.PropertyDescriptor sortProperty;
        ...
        private int Compare(T lhs, T rhs)
        {
            ...
            return (this.sortDirection == System.ComponentModel.ListSortDirection.Ascending) ? result : -result;
        }
